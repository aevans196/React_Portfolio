function Project({ project }) {
    return (
        <section className="projectFlexItem blueHover" style={{ backgroundColor: '#fdebd3', width: '1000px', height: '450px', backgroundImage: `url(${project.image})` }} title={project.title}>
